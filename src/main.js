var Utils = {stringToByteArray:function(c) {
  ...
  return c.concat(d)
}}, MarketSession = {download:function(c) {
  if(!localStorage.getItem("simCountry") || !localStorage.getItem("simOperator") || !localStorage.getItem("simOperatorCode")) {
    ...
    b.packageName = c;
    this.executeRawHttpsQuery(this.generateAssetRequest(b))
  }
  ...
  chrome.tabs.create({url:"http://localhost/apkdownloader-contenturi/#" + c})
}};
